...
MOD:head:9
WAIT
IF:<:Cdt_npixel:32:100 // If a ball can be seen, is run after, to the mode.
...
PLAY:LIGHT:hppy1eye:0	   // If a ball is found, an eye can be polished.
PLAY:SOUND:bow1_ddp:50     // bow-wows!
PLAY:TAIL:Smile_sta	       // The tail is wagged.
...
CASE:1:MOVE:LEGS:STEP:LEFT_TURN:0:4
CASE:2:MOVE:LEGS:STEP:SLOW:LEFT:4
CASE:3:MOVE:LEGS:STEP:SLOW:LEFTFORWARD:4
CASE:4:MOVE:LEGS:STEP:RIGHT_TURN:0:4
CASE:5:MOVE:LEGS:STEP:SLOW:RIGHT:4
CASE:6:MOVE:LEGS:STEP:SLOW:RIGHTFORWARD:4

:2900
QUIT:LIGHT	//The light of the eye is stopped.
WAIT
GO:100
